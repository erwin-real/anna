                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ action('MaterialController@update', $material->id) }}" method="POST">
                            ...
                            <div class="form-check row">
                                <input class="form-check-input" type="checkbox" checked="{{$material->retail == 1 ? true : false}}" name="retail" id="retail">
                            ...
                            <div class="form-check row">
                                <input class="form-check-input" type="checkbox" checked="{{$material->tax_exempt == 1 ? 'checked' : ''}}" name="tax_exempt" id="tax_exempt">
