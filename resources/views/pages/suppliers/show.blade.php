                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row d-block text-center">
                            ...
                            <img class="img-thumbnail rounded" src="/storage/supplier/{{$supplier->image}}" alt="">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="offset-1 col-10">
                                <span>{{ date('D M d, Y h:i a', strtotime($supplier->created_at)) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="offset-1 col-10">
                                <span>{{ date('D M d, Y h:i a', strtotime($supplier->updated_at)) }}</span>
                            </div>
                        </div>
