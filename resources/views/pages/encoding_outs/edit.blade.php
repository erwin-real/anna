...
@section('content')
    ...
    <div class="body-right">
        <div class="container-fluid">
            <h1 class="h2 mb-0 text-gray-800">Update MIR Encoding Out</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="/encodingOuts/{{$encodingOut->id}}">{{$encodingOut->pr}}</a>
                    </li>
            ...
            <div class="container-fluid mt-5 col-sm-12 col-lg-10 col-xl-7">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ action('EncodingOutController@update', $encodingOut->id) }}" method="POST" onsubmit="return check()">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <select id="department" name="department" class="form-control" required autofocus>
                                        <option value="department1" {{$encodingOut->department == 'department1' ? 'selected' : ''}}>department1</option>
                                        <option value="department2" {{$encodingOut->department == 'department2' ? 'selected' : ''}}>department2</option>
                                        <option value="department3" {{$encodingOut->department == 'department3' ? 'selected' : ''}}>department3</option>
                                    </select>
                                ...
                                <div class="col-md-12">
                                    <select id="customer" name="customer" class="form-control" required autofocus>
                                        @foreach($customers as $customer)
                                            <option value="{{$customer->id}}" {{$encodingOut->customer->id == $customer->id ? 'selected' : ''}}>{{$customer->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-12">
                                    <select id="supplier" name="supplier" class="form-control" required autofocus>
                                        @foreach($suppliers as $supplier)
                                            <option value="{{$supplier->id}}" {{$encodingOut->supplier->id == $supplier->id ? 'selected' : ''}}>{{$supplier->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <select id="assistant" name="assistant" class="form-control" required autofocus>
                                        <option value="Mr. Rodrigo Gumapos" {{$encodingOut->assistant == 'Mr. Rodrigo Gumapos' ? 'selected' : ''}}>Mr. Rodrigo Gumapos</option>
                                        <option value="Mr. Mark Francis David" {{$encodingOut->assistant == 'Mr. Mark Francis David' ? 'selected' : ''}}>Mr. Mark Francis David</option>
                                        <option value="Mr. Ricky Torio" {{$encodingOut->assistant == 'Mr. Ricky Torio' ? 'selected' : ''}}>Mr. Ricky Torio</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="pr" type="text" class="form-control{{ $errors->has('pr') ? ' is-invalid' : '' }}" value="{{$encodingOut->pr}}" name="pr" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="order_date" type="date"
                                           ...
                                           value="{{ date('Y-m-d', strtotime($encodingOut->order_date)) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <textarea id="remarks" type="text"
                                              ...
                                              name="remarks" autofocus>{{$encodingOut->remarks}}</textarea>
                                                ...
                                                <td>
                                                    <select class="form-control" name="materials[]">
                                                        @foreach($materials as $material)
                                                            <option value="{{$material->id}}" {{$material->id === $singleEncodingOut->material_id ? 'selected' : ''}}>{{$material->plu}} | {{$material->main_desc}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <input class="form-control" type="number" name="quantity[]" value="{{$singleEncodingOut->quantity}}" required>
                                                </td>
