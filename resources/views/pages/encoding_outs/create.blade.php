...
@section('content')
    ...
    <div class="body-right">
        <div class="container-fluid">
            <h1 class="h2 mb-0 text-gray-800">Add MIR Encoding Out</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add MIR Encoding Out</li>
                </ol>
            </nav>
            ...
            <div class="container-fluid mt-5 col-sm-12 col-lg-10 col-xl-7">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/encodingOuts" onsubmit="return check()">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if ($errors->has('date_delivered'))
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('date_delivered') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
