        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">
                        <a href="/forecasts/{{$forecast->id}}">{{$forecast->name}}</a>
                    </li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ action('ForecastController@update', $forecast->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$forecast->name}}" name="name" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="person" type="text" class="form-control{{ $errors->has('person') ? ' is-invalid' : '' }}" name="person" value="{{$forecast->person}}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="address" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{$forecast->address}}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="email" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{$forecast->email}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="contact" type="number" class="form-control{{ $errors->has('contact') ? ' is-invalid' : '' }}" name="contact" value="{{$forecast->contact}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="tin" type="number" class="form-control{{ $errors->has('tin') ? ' is-invalid' : '' }}" name="tin" value="{{$forecast->tin}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <select id="type" name="type" class="form-control" autofocus>
                                        <option value="Walk-in" {{$forecast->type == 'Walk-in' ? 'selected' : ''}}>Walk-in</option>
                                        <option value="Web Form" {{$forecast->type == 'Web Form' ? 'selected' : ''}}>Web Form</option>
                                        <option value="Phone Call" {{$forecast->type == '`Phone Call' ? 'selected' : ''}}>Phone Call</option>
                                        <option value="Viber" {{$forecast->type == 'Viber' ? 'selected' : ''}}>Viber</option>
                                    </select>
